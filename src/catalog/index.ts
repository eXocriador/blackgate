 ...
 *
 * Стеження — за mtime з інтервалом, а не `fs.watch`: файл монтується в
 * контейнер із хоста (`/srv/products/exo-ai/catalog.yaml`), а inotify крізь
 * bind-монт із хостової теки не доходить надійно — редактор, який пише через
 * `rename`, лишає стеження на старому inode. Опитування mtime не має цієї вади
 * і коштує один `stat` на 15 секунд.
 */
